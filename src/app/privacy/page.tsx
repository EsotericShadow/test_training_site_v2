 ...
 * Description: Privacy policy page server component that generates privacy-focused SEO metadata
 *              and renders the privacy policy content with structured data for enhanced legal compliance.
