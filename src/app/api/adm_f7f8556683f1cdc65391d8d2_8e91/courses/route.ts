 ...
 *
 * File: src/app/api/adm_f7f8556683f1cdc65391d8d2_8e91/courses/route.ts
 * Description: API routes for managing courses (GET, POST).
 * Dependencies: Next.js, Vercel Postgres, secure-jwt, security-utils, csrf
 * Created: 2025-06-06
