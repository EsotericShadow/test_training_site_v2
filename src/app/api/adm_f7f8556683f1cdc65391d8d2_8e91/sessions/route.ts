 ...
 *
 * File: src/app/api/adm_f7f8556683f1cdc65391d8d2_8e91/sessions/route.ts
 * Description: API routes for managing admin sessions (GET, DELETE).
 * Dependencies: Next.js, secure-jwt, logger, session-manager, csrf
 * Created: 2025-07-17
