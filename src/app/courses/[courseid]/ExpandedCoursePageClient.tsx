 ...
 *
 * File: ExpandedCoursePageClient.tsx
 * Description: Extended course page component with comprehensive course details and interactive elements.
 * Dependencies: React 19, Next.js 15, advanced course features
 * Created: June 3, 2025
  ...
  return (
    <div className="min-h-screen transition-colors duration-300">
      ...
      <section className="relative py-12 sm:py-20 text-white overflow-hidden">
        <div className="absolute inset-0 z-0 h-[500px] md:h-[600px]">
          {course.image_url ? (
            <Image
