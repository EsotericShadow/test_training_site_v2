...
export default function CoursePageClient({ course }: CoursePageClientProps) {
  // No client-side pre-processing needed if content is stored as proper markdown
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 rounded-2xl shadow-2xl p-8">
            <div className="space-y-12">
              ...
              <div className="backdrop-blur-md bg-white/10 border border-white/20 rounded-xl shadow-xl overflow-hidden p-8 mb-8">
                <h2 className="animate-in text-3xl font-bold text-gray-900 dark:text-white mb-6">What You&apos;ll Learn</h2>
                <div className="prose prose-lg dark:prose-invert max-w-none prose-ul:list-none prose-li:before:content-['►'] prose-li:before:mr-2 prose-li:before:text-yellow-500 prose-strong:font-bold prose-p:mb-4">
                  <ReactMarkdown remarkPlugins={[remarkGfm]} rehypePlugins={[rehypeRaw]}>
              ...
              {course.includes && (
                <div>
                  ...
                  <div className="prose prose-lg dark:prose-invert max-w-none text-gray-600 dark:text-gray-300 prose-ul:list-none prose-li:before:content-['►'] prose-li:before:mr-2 prose-li:before:text-yellow-500">
                    <ReactMarkdown remarkPlugins={[remarkGfm]} rehypePlugins={[rehypeRaw]}>
                    {course.includes}
                  </ReactMarkdown>
                  </div>
